  ...
  return (
    <QwikCityProvider>
      <head>
        ...
        {!isDev &&
          (import.meta as unknown as { env?: Record<string, string> })?.env?.VITE_ENABLE_PWA ===
            "1" && <link rel="manifest" href={`${import.meta.env.BASE_URL}manifest.json`} />}
        ...
        {isDev && <script src={`${import.meta.env.BASE_URL}debug-warn.js`} defer />}
        ...
        {(import.meta as unknown as { env?: Record<string, string> })?.env?.VITE_PREFETCH_AUTH ===
          "1" && (
          <>
      ...
      <body lang="en" class="bg-base-100 text-base-content flex min-h-screen flex-col">
