...
export const RouterHead = component$(() => {
  ...
  return (
    <>
      ...
      {(() => {
        ...
        return hasGoogleFonts ? (
          <>
            ...
            <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Inter:wght@400;700&display=swap" media="print" onLoad$={$((e: any) => {
              try {
                const el = (e?.currentTarget || e?.target) as HTMLLinkElement | null;
                if (el) el.media = 'all';
              } catch { /* ignore */ }
            })} />
            <noscript>
      ...
      {(() => {
        const hasDescription = head.meta.some((m: any) => m?.name === 'description');
        return hasDescription ? null : (
          <meta name="description" content="Stack — modern web app experience with motion, performance, and delightful design." />
        );
      })()}
