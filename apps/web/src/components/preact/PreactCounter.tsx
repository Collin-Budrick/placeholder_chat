  ...
  return (
    <div class="card bg-base-200 shadow-sm">
      <div class="card-body items-center text-center">
        ...
        <p class="text-sm opacity-70">This interactive counter runs with Preact.</p>
        <div class="join mt-2">
          <button
            type="button"
            class="btn join-item"
          ...
          <button type="button" class="btn btn-ghost join-item no-animation pointer-events-none">
            {count}
          </button>
          <button
            type="button"
