...
export const AuthCard = component$((props: AuthCardProps) => {
  ...
  return (
    <div class={`${base} ${props.error ? danger : normal}`}>
      {props.title && <h2 class="text-2xl font-semibold text-center mb-2">{props.title}</h2>}
      {props.subtitle && <p class="text-sm text-center text-base-content/70 mb-4">{props.subtitle}</p>}
