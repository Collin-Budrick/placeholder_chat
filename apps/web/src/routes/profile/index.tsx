...
export default component$(() => {
  ...
  useVisibleTask$(async () => {
    const from =
      (globalThis?.location?.pathname || "/profile") + (globalThis?.location?.search || "");
    try {
    ...
    <main class="flex min-h-screen items-center justify-center p-6">
      {show.value ? (
        <AuthCard title="Profile">
          <h3 class="mb-2 text-center text-xl font-semibold">Hi {displayName.value}</h3>
          <p class="mb-4 text-center text-sm text-slate-200">Manage your account</p>
        ...
        <output class="text-base-content/70 text-sm" aria-busy="true" aria-live="polite">
...
export const head: DocumentHead = {
  ...
  meta: [
    {
      name: "description",
      content: "View and manage your Stack profile, account details, and settings.",
    },
  ],
};
