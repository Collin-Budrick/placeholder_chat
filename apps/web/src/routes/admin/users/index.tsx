...
export const useUsersLoader = routeLoader$<{
	...
	const inDocker =
		ev.env.get("DOCKER_TRAEFIK") === "1" || process.env.DOCKER_TRAEFIK === "1";
	let base =
		envBase ?? (inDocker ? "http://gateway:7000" : "http://127.0.0.1:7000");
			...
			{deleteOpen.value && (
				<div class="fixed inset-0 flex items-center justify-center z-50">
					...
					<div class="bg-base-100 rounded-lg p-6 z-60 w-full max-w-md">
						...
						<p class="mb-3">
							Are you sure you want to delete <b>{deleteEmail.value}</b>? This
	...
	meta: [
		{
			name: "description",
			content:
				"Admin dashboard to view, promote, demote, and delete users in Stack.",
		},
	],
};
