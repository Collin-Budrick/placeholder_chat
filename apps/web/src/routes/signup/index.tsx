...
export default component$(() => {
  ...
  return (
    <main id="signup-root" class="grid min-h-screen place-items-center p-6 pt-20 md:pt-24">
      <div
          ...
          <AuthCard borderless error={cardError.value}>
            <MForm onSubmit$={onSubmit$}>
              ...
              <Field name="username">
                {(field, props) => (
                  <div class="form-control">
                    <label class="label" aria-label="Username" for={(props as any)?.id as string}>
                    ...
                    <input
                      ...
                      placeholder={
                        ...
                        (usernameAvailable.value === false || usernameTaken.value)
                      ...
                      aria-invalid={
                        !usernameEditing.value &&
                        (usernameAvailable.value === false || usernameTaken.value || !!field.error)
                          ? "true"
                          : undefined
                      }
              ...
              <Field name="email">
                {(field, props) => (
                  <div class="form-control">
                    <label class="label" aria-label="Email" for={(props as any)?.id as string}>
              ...
              <Field name="password">
                {(field, props) => (
                  <div class="form-control">
                    <label class="label" aria-label="Password" for={(props as any)?.id as string}>
                    ...
                    <input
                      ...
                      type="password"
                      placeholder={
                        field.error && !passwordEditing.value ? field.error : "Create a password"
                      }
                      class={cn(
                        "pill-input w-full",
...
export const head: DocumentHead = {
  ...
  meta: [
    {
      name: "description",
      content: "Create your Stack account to start building and personalize your experience.",
    },
  ],
};
