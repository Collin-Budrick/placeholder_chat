...
export default component$(() => {
  ...
  return (
    <main id="login-root" class="grid min-h-screen place-items-center p-6 pt-20 md:pt-24">
      <div
            ...
            <form
              ...
              onSubmit$={$(async (ev: Event) => {
                try {
                  ...
                  const byId = (globalThis?.document?.getElementById?.("login-form") ??
                    null) as HTMLFormElement | null;
                  const fromCurrent = ev.currentTarget as HTMLFormElement | null;
                  const fromTargetClosest = ((): HTMLFormElement | null => {
                    const t = ev.target as Element | null;
                    const found = t && typeof t.closest === "function" ? t.closest("form") : null;
                  ...
                  if (!parsed.success) {
                    const msg = parsed.issues?.[0]?.message || "Invalid credentials";
