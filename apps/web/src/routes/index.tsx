import { component$, isServer, useSignal, useVisibleTask$ } from "@builder.io/qwik";
        ...
        <div class="relative mx-auto max-w-7xl px-6 pt-20 pb-14">
          <div class="grid items-center gap-10 md:grid-cols-2 md:gap-12">
            <div class="text-center md:text-left">
              ...
              >
                Real‑time chats, rich profiles, and a playful, modern UI — all on a silky glass
                surface with a subtle grain texture.
              </p>
              <div
                ref={ctaRef}
                style={{ opacity: "0" }}
                class={cn("mt-8 flex items-center justify-center gap-4 md:justify-start")}
              >
                  ...
                  <div class="mt-4 space-y-3">
                    <div class="flex items-center gap-3" data-reveal>
                      <div class="avatar placeholder">
                        <div class="bg-base-300 text-base-content grid h-8 w-8 place-items-center rounded-full">
                          <span>M</span>
                        </div>
                      </div>
                      <div>
        ...
        <div class="grid gap-6 md:grid-cols-3">
          ...
          <div class="glass-surface border-soft with-grain card bg-base-100/5 border" data-reveal>
            <div class="card-body">
              ...
              <p class="opacity-70">
                Low‑latency rooms, typing indicators, and read receipts that feel instant.
              </p>
            </div>
          </div>
          {/** Feature 2 **/}
          <div class="glass-surface border-soft with-grain card bg-base-100/5 border" data-reveal>
            <div class="card-body">
              ...
              <p class="opacity-70">
                DaisyUI surfaces with delicate grain, tasteful depth, and OLED‑friendly contrast.
              </p>
            </div>
          </div>
          {/** Feature 3 **/}
      ...
      <section class="mx-auto max-w-7xl px-6 py-8 md:py-10">
        <div class="grid items-center gap-8 md:grid-cols-2">
          <div class="order-2 md:order-1">
            <h2 class="text-2xl font-bold md:text-3xl">Conversations that feel alive</h2>
            <p class="text-base-content/70 mt-3">
              Reactions, short replies, link previews, and smooth transitions. Powerful yet friendly
              — a space that invites talking.
            </p>
